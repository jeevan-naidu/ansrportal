...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        shortAttendanceApply(options['year'], options['month'], options['day'])


def shortAttendanceApply(year, month, day):
    duedate = date(year, month, day)
    print str(duedate) + " short attendance auto apply started running"
