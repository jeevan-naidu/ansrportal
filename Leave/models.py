...
class LeaveApplications(models.Model):
    ...
    hours = models.CharField(max_length=4, verbose_name='Reason',blank=True, null=True,)
    temp_id = models.CharField(max_length=2, verbose_name='Reason',blank=True, null=True,)
...
class CreditEntry(models.Model):
    ...
    leave_type = models.ForeignKey(LeaveType, default=1)
    days = models.CharField(verbose_name="days", max_length=5)
    status_action_by = models.ForeignKey(User, verbose_name="Action_Taken_by")
    status_action_on = models.DateField(auto_now=True, verbose_name='Status Change date')
    comments = models.CharField(max_length=100, verbose_name="status_comments")
