# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2017-06-07 12:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('return_status', models.CharField(choices=[(b'initiated', b'INITIATED'), (b'returned', b'RETURNED'), (b'approved', b'APPROVED')], default=None, max_length=20)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.TextField(blank=True, null=True)),
                ('approved_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transaction_approved_user', to=settings.AUTH_USER_MODEL)),
                ('laptop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='LaptopAvail.LaptopApply')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='laptopapply',
            name='laptop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='LaptopAvail.Laptops'),
        ),
        migrations.AddField(
            model_name='laptopapply',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='laptopapply_requested_by', to=settings.AUTH_USER_MODEL),
        ),
    ]
