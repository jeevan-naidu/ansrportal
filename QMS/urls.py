...
urlpatterns = [
    ...
    url(r'^write_qms_chapter_level_summary/$', login_required(write_qms_chapter_level_summary),
        name=u'write_qms_chapter_level_summary'),
    ...
    url(r'^AutocompleteProjectQMS/$', login_required(AutocompleteProjectQMS.as_view()), name='AutocompleteProjectQMS', ),
    ...
    url(r'^AutoCompleteUserProjectSpecific/$', login_required(AutoCompleteUserProjectSpecific.as_view()),
