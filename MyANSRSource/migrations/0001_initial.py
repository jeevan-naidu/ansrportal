    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdOn', models.DateTimeField(auto_now_add=True, verbose_name=b'created Date')),
                ('updatedOn', models.DateTimeField(auto_now=True, verbose_name=b'Updated Date')),
                ('name', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='MyANSRSource.Milestone', verbose_name=b'Milestone Name')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyANSRSource.Project')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='projectdetail',
            name='SubPractice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='CompanyMaster.SubPractice', verbose_name=b'Sub Practice'),
        ),
        migrations.AddField(
            model_name='projectdetail',
            name='deliveryManager',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name=b'Project Delievery Manager'),
        ),
        migrations.AddField(
            model_name='projectdetail',
            name='project',
        ...
        migrations.AddField(
            model_name='project',
            name='projectManager',
            field=models.ManyToManyField(through='MyANSRSource.ProjectManager', to=settings.AUTH_USER_MODEL, verbose_name=b'Delievery CO-ordinator'),
        ),
        migrations.AddField(
            model_name='project',
            name='projectType',
