...
urlpatterns = [
    ...
    url(r'^program/create$',
        views.CreateProgram,
        name=u'createprogram'),
    url(r'^program/approve$',
        views.ApproveProgram,
        name=u'approveprogram'),
    url(r'^program/rejected',
        views.RejectedProgram,
        name=u'rejectedprogram'),
    url(r'^program/change_request',
        views.ProgramChangeRequest,
        name=u'programchangerequest'),
    url(r'^program/approve_change_request$',
        views.ApproveProgramChangeRequest,
        name=u'approveprogramchangerequest'),
    url(r'^project/save$',
        views.saveProject,
        name=u'saveproject'),
    ...
    url(r'^reports/invoice-report$',
        reportviews.InvoiceReport,
        name=u'InvoiceReport'),
    url(r'^reports/project-report$',
        reportviews.ProjectReport,
        name=u'ProjectReport'),
    # url(r'^reports/btgdetail/$',
    #     login_required(views.btg_detail),
    #     name='btgdetail'),
    ...
    url(r'^project/projectdetail/$',
        ...
        name='projectdetail'),
    url(r'^program/programdetail/$',
        login_required(views.program_detail),
        name='programdetail'),
    url(r'^project/project_change_detail/$',
        login_required(views.project_change_detail),
        name='project_change_detail'),
    url(r'^project/change_request_detail/$',
        login_required(views.change_request_detail),
