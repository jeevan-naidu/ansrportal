...
urlpatterns = [
		       ...
		       url(r'^AutocompleteGrievanceAdmin/$',login_required(AutocompleteGrievanceAdmin.as_view()),name=u'AutocompleteGrievanceAdmin'),
url(
        r'^AutocompleteUser/$',
        login_required(AutocompleteUser.as_view()),
