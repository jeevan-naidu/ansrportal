    ...
    if request.method == 'POST':
        ...
        if datetime.strptime(startDate, '%Y-%m-%d').date() == datetime.now().date() and datetime.strptime(endDate,
            ...
            if reportData.is_valid():
                bu = reportData.cleaned_data['bu']
                if bu == '0':
                    values = (list(ProjectMilestone.objects.filter(financial=0, closed=1, milestoneDate__range=(startDate, endDate)).values('id', 'amount','project_id__projectId','project_id__bu__name',
                                                                                                                'project_id__customer__name','project_id__totalValue',
                                                                                                                'project_id__name',
                                                                                                                'project_id__customer',
                                                                                                                'project_id__startDate', 'milestoneDate',
                    ...
                    values = (list(ProjectMilestone.objects.filter(financial=0, project_id__bu=bu, closed=1, milestoneDate__range=(startDate, endDate)).values('id', 'amount','project_id__projectId','project_id__bu__name',
                                                                                                               'project_id__name','project_id__customer__name','project_id__totalValue',
                                                                                                               'project_id__customer',
                                                                                                               'project_id__startDate',
                                                                                                               'project_id__endDate', 'milestoneDate',
