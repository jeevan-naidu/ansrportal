# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2017-02-16 08:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projectFinType', models.CharField(blank=True, choices=[(b'FP', b'Fixed Price'), (b'T&M', b'T&M')], max_length=40, null=True, verbose_name=b'Project Finance Type ')),
                ('ProjectCost', models.CharField(blank=True, max_length=100, null=True, verbose_name=b'Project cost')),
                ('PracticeHead', models.CharField(blank=True, max_length=100, null=True, verbose_name=b'Practice Head')),
                ('deliveryManager', models.IntegerField(blank=True, verbose_name=b'Project Delievery Manager')),
                ...
                ('createdOn', models.DateTimeField(auto_now_add=True, verbose_name=b'created Date')),
                ('updatedOn', models.DateTimeField(auto_now=True, verbose_name=b'Updated Date')),
                ('PracticeName', models.ForeignKey(blank=True, max_length=200, null=True, on_delete=django.db.models.deletion.CASCADE, to='CompanyMaster.Practice', verbose_name=b'Practice Name')),
                ('SubPractice', models.ForeignKey(blank=True, max_length=200, null=True, on_delete=django.db.models.deletion.CASCADE, to='CompanyMaster.SubPractice', verbose_name=b'Sub Practice')),
