    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=40, verbose_name=b'Designation Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_acccount', models.IntegerField(unique=True, max_length=30, verbose_name=b'Account Number')),
                ...
                ('permanent_address', models.ForeignKey(related_name='permanent_addr', verbose_name=b'Permanent Address', to='employee.EmpAddress')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='employee.PreviousEmployment'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='employee',
            name='temporary_address',
            field=models.ForeignKey(related_name='temporary_addr', verbose_name=b'Temporary Address', to='employee.EmpAddress'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='employee',
