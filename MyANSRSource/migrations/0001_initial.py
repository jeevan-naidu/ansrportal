    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdon', models.DateTimeField(auto_now_add=True, verbose_name=b'created Date')),
                ('updatedon', models.DateTimeField(auto_now=True, verbose_name=b'Updated Date')),
                ('name', models.CharField(default=None, max_length=100, null=True, verbose_name=b'name')),
                ('is_final_milestone', models.BooleanField(default=False, verbose_name=b'Is Final Milestone')),
                ('check_schedule_deviation', models.BooleanField(default=False, verbose_name=b'Check Schedule Deviation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('milestone_type', models.CharField(max_length=50, verbose_name=b'Milestone Type')),
                ('is_financial', models.BooleanField(default=False, verbose_name=b'Is Financial')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plannedEffort', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(8)], verbose_name=b' Total Planned Effort')),
                ...
                ('totalValue', models.DecimalField(decimal_places=2, default=0.0, max_digits=12, validators=[django.core.validators.MinValueValidator(0.0)], verbose_name=b'Project Value')),
                ('closed', models.BooleanField(default=False, verbose_name=b'Project Closed')),
                ('remark', models.CharField(blank=True, default=b'Nothing', max_length=100, null=True, verbose_name=b'Project Rejection message')),
                ('active', models.BooleanField(default=False, verbose_name=b'Is Active')),
                ('rejected', models.BooleanField(default=False, verbose_name=b'Rejected or not')),
                ('createdOn', models.DateTimeField(auto_now_add=True, verbose_name=b'created Date')),
                ('updatedOn', models.DateTimeField(auto_now=True, verbose_name=b'Updated Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Asset', models.CharField(max_length=200, verbose_name=b'Project Asset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startDate', models.DateField(blank=True, null=True, verbose_name=b'Revised Project Start Date')),
                ('Sowdocument', models.FileField(blank=True, null=True, upload_to=MyANSRSource.models.change_file_path, verbose_name=b'Upload Project SOW')),
                ('estimationDocument', models.FileField(blank=True, null=True, upload_to=MyANSRSource.models.change_file_path, verbose_name=b'Upload Estimation Document')),
                ('createdOn', models.DateTimeField(auto_now_add=True, verbose_name=b'created Date')),
                ('updatedOn', models.DateTimeField(auto_now=True, verbose_name=b'Updated Date')),
                ('approved', models.CharField(choices=[(b'0', b'ACTIVE'), (b'1', b'APPROVED'), (b'2', b'REJECTED')], default=0, max_length=1, verbose_name=b'Approved')),
                ('bu', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='CompanyMaster.BusinessUnit', verbose_name=b'Business Unit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('projectFinType', models.CharField(blank=True, choices=[(b'FP', b'Fixed Price'), (b'T&M', b'T&M')], max_length=20, null=True, verbose_name=b'Project Finance Type ')),
                ('Sowdocument', models.FileField(blank=True, null=True, upload_to=MyANSRSource.models.change_file_path, verbose_name=b'Upload Project SOW')),
                ('Estimationdocument', models.FileField(blank=True, null=True, upload_to=MyANSRSource.models.change_file_path, verbose_name=b'Upload project Estimation Document')),
                ('outsource_contract_value', models.DecimalField(decimal_places=2, default=0.0, max_digits=12, validators=[django.core.validators.MinValueValidator(0.0)], verbose_name=b'Outsource Contract Value')),
                ('Asset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='MyANSRSource.ProjectAsset', verbose_name=b'Project Asset ID')),
                ('PracticeName', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='CompanyMaster.Practice', verbose_name=b'Practice Name')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('financial', models.BooleanField(default=False, verbose_name=b'Deviation')),
                ('reason', models.CharField(blank=True, default=None, max_length=100, null=True, verbose_name=b'Reason for change')),
                ('createdOn', models.DateTimeField(auto_now_add=True, verbose_name=b'created Date')),
                ('updatedOn', models.DateTimeField(auto_now=True, verbose_name=b'Updated Date')),
                ('name', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='MyANSRSource.Milestone', verbose_name=b'Milestone Name')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyANSRSource.Project')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('scope', models.CharField(max_length=200, verbose_name=b'Project scope Name')),
                ('IsActive', models.BooleanField(verbose_name=b'Active')),
                ('createdOn', models.DateTimeField(auto_now_add=True, verbose_name=b'created Date')),
                ('updatedOn', models.DateTimeField(auto_now=True, verbose_name=b'Updated Date')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            name='ProjectSopTemplate',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=120, verbose_name=b'process Template name')),
                ('is_active', models.BooleanField(default=True, verbose_name=b'Active or not')),
                ('product_type', models.CharField(choices=[(0, b'assessment'), (b'1', b'learning')], max_length=15, verbose_name=b'type of product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name=b'Quality SOP Name')),
                ('SOPlink', models.TextField(validators=[django.core.validators.URLValidator()])),
                ('createdOn', models.DateTimeField(auto_now_add=True, verbose_name=b'created Date')),
                ('updatedOn', models.DateTimeField(auto_now=True, verbose_name=b'Updated Date')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.CharField(blank=True, default=None, max_length=255, null=True, verbose_name=b'Employee Remarks')),
        ...
        migrations.AddField(
            ...
            name='SOP',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='MyANSRSource.qualitysop', verbose_name=b'Quality Sop ID'),
        ),
        migrations.AddField(
            model_name='projectdetail',
            name='Scope',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='MyANSRSource.ProjectScope', verbose_name=b'Project Scope ID'),
        ),
        migrations.AddField(
            model_name='projectdetail',
            name='deliveryManager',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name=b'Project Delievery Manager'),
        ),
        migrations.AddField(
            model_name='projectdetail',
            name='pmDelegate',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pmDelegate', to=settings.AUTH_USER_MODEL, verbose_name=b'PM Delegate'),
        ),
        migrations.AddField(
            model_name='projectdetail',
            name='project',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='MyANSRSource.Project'),
        ),
        migrations.AddField(
            model_name='project',
            name='projectManager',
            field=models.ManyToManyField(through='MyANSRSource.ProjectManager', to=settings.AUTH_USER_MODEL, verbose_name=b'Additional Manager'),
        ),
        migrations.AddField(
            model_name='project',
            name='projectType',
        ...
        migrations.AddField(
            ...
            name='milestone_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyANSRSource.MilestoneType'),
        ),
        migrations.AddField(
