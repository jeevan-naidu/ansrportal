    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_session', models.CharField(max_length=20, verbose_name=b'Leave From session', choices=[(b'session_first', b'First Half'), (b'session_second', b'Second Half')])),
                ('to_date', models.DateField(verbose_name=b'Leave to Date')),
                ('to_session', models.CharField(max_length=20, verbose_name=b'Leave To session', choices=[(b'session_first', b'First Half'), (b'session_second', b'Second Half')])),
                ('reason', models.CharField(max_length=1000, null=True, verbose_name=b'Reason', blank=True)),
                ('status', models.CharField(max_length=100, verbose_name=b'Status Of Leave', choices=[(b'open', b'Open'), (b'approved', b'Approved'), (b'rejected', b'Rejected'), (b'cancelled', b'Cancelled'), (b'applied', b'Applied')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('leave_type', models.CharField(max_length=50, verbose_name=b'Leave Types', choices=[(b'earned_leave', b'Earned Leave'), (b'sick_leave', b'Sick Leave'), (b'casual_leave', b'Casual Leave'), (b'loss_of_pay', b'Loss Of Pay'), (b'bereavement_leave', b'Bereavement Leave'), (b'maternity_leave', b'Maternity Leave'), (b'paternity_leave', b'Paternity Leave'), (b'comp_off_apply', b'Comp Off Apply'), (b'comp_off_avail', b'Comp Off Avail'), (b'pay_off', b'Pay Off'), (b'work_from_home', b'Work From Home'), (b'sabbatical', b'Sabbatical')])),
