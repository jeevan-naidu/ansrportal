# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-09-19 06:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('short_leave_type', models.CharField(choices=[(b'half_day', b'HALF'), (b'full_day', b'FULL')], max_length=50, verbose_name=b'leave type')),
