...
class LeaveApplications(models.Model):
    ...
    apply_by = models.ForeignKey(User, verbose_name='Leaved applied by ', related_name='applied_by_user', blank=True, null=True)
    ...
    def saveas(self, user, applied_by, *args, **kwargs):
        ...
        self.status = 'open'
        self.apply_by = User.objects.get(id=applied_by)
